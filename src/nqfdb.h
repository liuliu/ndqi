...
bool nqfdbidx(NQFDB* fdb, int naive = 10, double rho = 0.75, double tau = 0.2);
bool nqfdbmgidx(NQFDB* fdb, int max, int naive = 10, double rho = 0.75, double tau = 0.2);
bool nqfdbreidx(NQFDB* fdb, int naive = 10, double rho = 0.75, double tau = 0.2);
