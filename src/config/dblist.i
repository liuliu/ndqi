...
NQ_DATABASE("kod", NQTTCTDB, 0, "kod.db", "face.num|n people.num|n")
NQ_DATABASE("lh", NQTFDB, 0, "lh.db", NULL)
NQ_DATABASE("lpd", NQTBWDB, NQBW_LIKE_BEST_MATCH_COUNT, "lpd.db", NULL)
NQ_DATABASE("misc", NQTTCTDB, 0, "misc.db", "width|n height|n name|s year|n month|n day|n hour|n minute|n second|n weekday|n datetime|n")
